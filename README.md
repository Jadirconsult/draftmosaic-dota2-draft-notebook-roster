...
<div align="center">
  <img src="./public/logo.svg" alt="DraftMosaic — Dota 2 — Roster" width="64" height="64">
  <h1>DraftMosaic — Dota 2 — Roster</h1>
</div>

An independent project specification for Dota 2, covering draft scenario sheets, role coverage matrix, patch-tagged matchup notes.
...
<img src="./public/screenshots/desktop-main.svg" alt="Dota 2 — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Dota 2 — compact concept, not a screenshot" width="250">
<br>
...
- **Draft scenario sheets** — planned module; not implemented.
- **Role coverage matrix** — planned module; not implemented.
- **Patch-tagged matchup notes** — planned module; not implemented.

The proposed workflow separates draft scenario sheets from role coverage matrix, with patch-tagged matchup notes retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Draft scenario sheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="DraftMosaic — Dota 2 — Roster — specification review workflow">
<br>
...
### Draft scenario sheets

Define the input and expected outcome for module 1. Record the Dota 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Role coverage matrix

Define the input and expected outcome for module 2. Record the Dota 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Patch-tagged matchup notes

Define the input and expected outcome for module 3. Record the Dota 2 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Draft scenario sheets |
